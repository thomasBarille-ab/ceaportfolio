  ...
  return (
    <SlideLayout accent="#fb923c">
      <div className="flex-1 min-h-0 flex flex-col items-center justify-center text-center gap-6">
        ...
        <div className="flex items-center gap-3 text-xs text-stone-400 border border-stone-700 rounded-full px-5 py-2 shrink-0">
        ...
        <div className="shrink-0">
          <h1 className="text-6xl font-bold tracking-tight text-white leading-none">
            Thomas <span className="text-orange-400">Barille</span>
          </h1>
          <p className="mt-3 text-lg text-stone-400">EPSI Bordeaux · Promotion EISI 2025</p>
        </div>
        ...
        <div className="flex items-center gap-4 text-stone-400 text-sm shrink-0">
          <span>3 ans d'alternance</span>
          <span className="text-stone-700">·</span>
          <span className="text-orange-400 font-medium">CEA Tech Occitanie</span>
          <span className="text-stone-700">·</span>
          <span>Tuteur : Hugo Duret</span>
        </div>

        <p className="text-xs text-stone-600 tracking-widest uppercase shrink-0">
