  ...
  return (
    <SlideLayout accent="#34d399">
      ...
      <div className="shrink-0 mb-5">
        ...
        <p className="text-stone-400 text-sm mt-1">Obstacles techniques et organisationnels surmontés</p>
      </div>
      ...
      <div className="flex-1 min-h-0 flex gap-5">
        ...
        <div className="flex-1 min-h-0 flex flex-col gap-3">
          {defis.map(d => (
            <div key={d.title} className="flex-1 min-h-0 bg-white/5 border border-emerald-500/20 rounded-2xl p-4 overflow-hidden">
              <div className="flex gap-3">
                ...
                <div>
                  ...
                  <div className="mt-2 flex items-start gap-2">
                    ...
                    <p className="text-emerald-300 text-xs leading-relaxed">{d.solution}</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="w-[340px] shrink-0 flex flex-col gap-3">
          <div className="flex-1 min-h-0 bg-white/5 border border-emerald-500/25 rounded-2xl overflow-hidden flex flex-col">
            <div className="shrink-0 px-4 pt-3 pb-2">
              <p className="text-xs text-emerald-400 font-semibold uppercase tracking-wider">Kanban NACRE</p>
              <p className="text-xs text-stone-500 mt-0.5">À faire · En cours · À valider · Terminées</p>
            </div>
          ...
          <div className="shrink-0 bg-white/5 border border-emerald-500/25 rounded-2xl px-4 py-3">
            <div className="grid grid-cols-3 gap-3 text-center text-xs">
              <div>
                <p className="text-stone-400">Format livrable</p>
                <p className="text-white font-semibold mt-0.5">.exe / .dmg</p>
              </div>
              <div>
                <p className="text-stone-400">Durée projet</p>
                <p className="text-white font-semibold mt-0.5">2 mois</p>
              </div>
              <div>
                <p className="text-stone-400">Équipe</p>
