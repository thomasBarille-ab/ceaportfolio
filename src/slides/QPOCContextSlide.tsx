    ...
    <SlideLayout accent="#fbbf24">
      ...
      <div className="shrink-0 mb-5">
        <div className="flex items-center gap-3 mb-2">
          ...
          <span className="text-stone-500 text-sm">Plateforme DIGIT — CEA Tech Occitanie</span>
        </div>
        <h2 className="text-3xl font-bold text-white">Quick POC</h2>
        <p className="text-stone-400 text-sm mt-1">Générateur de code & agrégateur de services</p>
      </div>
          ...
          <div className="flex-1 min-h-0 bg-white/5 border border-amber-500/25 rounded-2xl p-4 overflow-hidden">
            ...
            <div className="space-y-3">
              {perimeter.map(({ cat, items }) => (
                <div key={cat}>
                  <p className="text-stone-500 text-xs mb-1.5">{cat}</p>
        ...
        <div className="w-64 shrink-0 flex flex-col gap-3">
          <div className="flex-1 min-h-0 bg-white/5 border border-amber-500/25 rounded-2xl p-4 flex flex-col overflow-hidden">
            ...
            <div className="mt-auto pt-4 shrink-0">
              <p className="text-xs text-stone-500 mb-2">Public cible</p>
