  ...
  return (
    <SlideLayout accent="#f59e0b">
      ...
      <div className="shrink-0 mb-5">
        ...
        <p className="text-slate-400 text-sm mt-1">Gestion de la complexité dans un projet en continu</p>
      </div>
            ...
            <div className="space-y-2">
              {timeline.map(({ phase, label, done }) => (
                <div key={phase} className="flex items-start gap-3">
                  <div className={`w-4 h-4 rounded-full flex items-center justify-center shrink-0 mt-0.5 border ${done ? 'bg-amber-500 border-amber-400' : 'border-slate-600'}`}>
        ...
        <div className="w-[340px] shrink-0 flex flex-col gap-3">
          <div className="flex-1 min-h-0 bg-white/5 border border-amber-500/25 rounded-2xl overflow-hidden flex flex-col">
            <div className="shrink-0 px-4 pt-3 pb-2">
              ...
              <p className="text-xs text-slate-500 mt-0.5">TODO · WIP · Validation · Fait</p>
            </div>
          ...
          <div className="shrink-0 bg-white/5 border border-amber-500/25 rounded-2xl px-4 py-3">
            <div className="grid grid-cols-3 gap-3 text-center text-xs">
              <div><p className="text-slate-400">Équipe</p><p className="text-white font-semibold mt-0.5">3 alternants</p></div>
              <div><p className="text-slate-400">Stakeholders</p><p className="text-white font-semibold mt-0.5">5 CDI clients</p></div>
              <div><p className="text-slate-400">Jalons</p><p className="text-white font-semibold mt-0.5">3 livrables</p></div>
            </div>
          </div>
        </div>
      </div>
